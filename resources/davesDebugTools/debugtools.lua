...
Citizen.CreateThread(function()	
  while true do
	...
	local isEntityNetworked = NetworkHasControlOfEntity(dude10)
	 ...
	 DrawSprite("fiveM_VehicleTextures", "dukes", 0.5, 0.5, 0.5, 0.5, 0.0, 255, 255, 255, 255)
     ...
     drawTxt(tostring(entityCoords.x) , 6, 1, debugWindowXPos + 0.05, debugWindowYPos - 0.100, 0.6, 0, 0, 255, 255)
     drawTxt("entity Y coords: ", 6, 1, debugWindowXPos - 0.05, debugWindowYPos - 0.070, 0.6, 0, 255, 0, 255)
     drawTxt(tostring(entityCoords.y) , 6, 1, debugWindowXPos + 0.05, debugWindowYPos - 0.070, 0.6, 0, 0, 255, 255)
     drawTxt("entity Z coords: ", 6, 1, debugWindowXPos - 0.05, debugWindowYPos - 0.040, 0.6, 0, 255, 0, 255)
     drawTxt(tostring(entityCoords.z) , 6, 1, debugWindowXPos + 0.05, debugWindowYPos - 0.040, 0.6, 0, 0, 255, 255)
     drawTxt('entity X rotation: ', 6, 1, debugWindowXPos - 0.05, debugWindowYPos - 0.010, 0.6, 0, 0, 255, 255)
     drawTxt(tostring(entityRot.x) , 6, 1, debugWindowXPos + 0.05, debugWindowYPos - 0.010, 0.6, 0, 255, 0, 255)
     drawTxt('entity Y rotation: ', 6, 1, debugWindowXPos - 0.05, debugWindowYPos + 0.020, 0.6, 0, 0, 255, 255)
     drawTxt(tostring(entityRot.y) , 6, 1, debugWindowXPos + 0.05, debugWindowYPos + 0.020, 0.6, 0, 255, 0, 255)
     drawTxt('entity Z rotation: ', 6, 1, debugWindowXPos - 0.05, debugWindowYPos + 0.050, 0.6, 0, 0, 255, 255)
     drawTxt(tostring(entityRot.z) , 6, 1, debugWindowXPos + 0.05, debugWindowYPos + 0.050, 0.6, 0, 255, 0, 255)
     drawTxt('Player X rotation: ', 6, 1, debugWindowXPos - 0.05, debugWindowYPos + 0.08, 0.6, 0, 255, 0, 255)
     drawTxt(tostring(playerRot.x) , 6, 1, debugWindowXPos + 0.055, debugWindowYPos + 0.080, 0.6, 0, 0, 255, 255)
     drawTxt('Player Y rotation: ', 6, 1, debugWindowXPos - 0.05, debugWindowYPos + 0.110, 0.6, 0, 255, 0, 255)
     drawTxt(tostring(playerRot.y) , 6, 1, debugWindowXPos + 0.05, debugWindowYPos + 0.110, 0.6, 0, 0, 255, 255)
     drawTxt('Player Z rotation: ', 6, 1, debugWindowXPos - 0.05, debugWindowYPos + 0.140, 0.6, 0, 255, 0, 255)
     drawTxt(tostring(playerRot.z) , 6, 1, debugWindowXPos + 0.05, debugWindowYPos + 0.140, 0.6, 0, 0, 255, 255)
     drawTxt('Player X position: ', 6, 1, debugWindowXPos - 0.05, debugWindowYPos + 0.170, 0.6, 0, 0, 255, 255)
     drawTxt(tostring(playerCoords.x) , 6, 1, debugWindowXPos + 0.05, debugWindowYPos + 0.170, 0.6, 0, 255, 0, 255)
     drawTxt('Player Y position: ', 6, 1, debugWindowXPos - 0.05, debugWindowYPos + 0.20, 0.6, 0, 0, 255, 255)
     drawTxt(tostring(playerCoords.y) , 6, 1, debugWindowXPos + 0.05, debugWindowYPos + 0.20, 0.6, 0, 255, 0, 255)
     drawTxt('Player Z position: ', 6, 1, debugWindowXPos - 0.05, debugWindowYPos + 0.23, 0.6, 0, 0, 255, 255)
     drawTxt(tostring(playerCoords.z) , 6, 1, debugWindowXPos + 0.05, debugWindowYPos + 0.23, 0.6, 0, 255, 0, 255)
     drawTxt('Player Heading: ', 6, 1, debugWindowXPos - 0.05, debugWindowYPos + 0.26, 0.6, 0, 0, 255, 255)
     drawTxt(tostring(playerHeading), 6, 1, debugWindowXPos + 0.05, debugWindowYPos + 0.26, 0.6, 0, 255, 255, 255)
	 drawTxt('Player UUID: ', 6, 1, debugWindowXPos - 0.05, debugWindowYPos + 0.29, 0.6, 255, 255, 0, 255)
     drawTxt(tostring(handle), 6, 1, debugWindowXPos + 0.05, debugWindowYPos + 0.29, 0.6, 200, 100, 255, 255)
...
function deleteStuff()
 ...
 if DoesEntityExist(dude10) and not DoesEntityExist(a) then
 closestEntity = NetworkGetNetworkIdFromEntity(dude10)    
